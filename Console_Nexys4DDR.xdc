...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { centre }]; #IO_L9P_T1_DQS_14 Sch=btnc
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { nord }]; #IO_L4N_T0_D05_14 Sch=btnu
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { ouest }]; #IO_L12P_T1_MRCC_14 Sch=btnl
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { est }]; #IO_L10N_T1_D15_14 Sch=btnr
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { sud }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
...
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { rx_left }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { rx_right }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
...
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { rot_a_console }]; #IO_L11N_T1_SRCC_15 Sch=jb[7]
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { rot_b_console }]; #IO_L5P_T0_AD9P_15 Sch=jb[8]
...
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { tx_right }]; #IO_L23N_T3_35 Sch=jc[1]
set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { tx_left }]; #IO_L19N_T3_VREF_35 Sch=jc[2]
...
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { rot_a_manette }]; #IO_L6P_T0_35 Sch=jc[7]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { rot_b_manette }]; #IO_L22P_T3_35 Sch=jc[8]
...
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { SDI }]; #IO_L11P_T1_SRCC_15 Sch=acl_miso
set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS33 } [get_ports { SDO }]; #IO_L5N_T0_AD9N_15 Sch=acl_mosi
